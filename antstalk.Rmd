...
##  ANTs*R* Platform for Medical Imaging
...
# ANTs was begotten in SyN: Community demand for better technology
...
_Answer_:  Use prediction of demographics from quantitative data as a reference for the power of our methods.  One of the most well-known, most easily obtained,
...
# Can we implement and release, with provenance, a full multiple modality pipeline quantifying adolescent development from public multiple modality MRI data?
