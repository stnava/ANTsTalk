...
author: Brian B. Avants (<span style="color:blue;">PENN</span>) and <br />Nicholas J. Tustison (UVA)
...
# this strong <span style="color:red;">mathematical and software engineering</span> foundation leads to near limitless opportunities for innovation in a variety of application domains

# plug *your ideas* into our software to gain insight into biomedical data ...

 

# The *ANTs* Big Five: SyN, Atropos, N4, MALF (and introducing ... ) <span style="color:grey;">*R*</span>
...
## SyN was an answer to:<br /> "Can we do a better job of aligning these brains?"
...
for ( i in 1:simnum ) {
  ...
  img1sim[ mask==1 ]<-img1sim[ mask==1 ]+rnorm(nvox)
  img2sim<-antsImageClone(img2)
  img2sim[ mask==1 ]<-img2sim[ mask==1 ]+rnorm(nvox)
...
all the power of *R* $+$ the power of *ANTs* ...
...
## *ANTs* also specializes in longitudinal analysis
