...
* Registration $=$ geometric mapping between image pairs or image sets

* Diffeomorphisms $=$ differentiable map with differentiable inverse ("silly putty", viscous fluid)  

* Segmentation $=$ labeling tissue or anatomy in images, usually automated

* Multivariate $=$ using many voxels or measurements at once 

* Multiple modality $=$ using many modalities at once
