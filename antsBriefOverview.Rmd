...
<--!
#  *ANTs* is built from general <span style="color:red;">mathematical</span> and <span style="color:red;">software engineering</span> principles
-->
...
[BRATS 2013 Challenge](http://hal.inria.fr/docs/00/93/56/40/PDF/brats_preprint.pdf)
